    ...
    useEffect(() => {
        ...
        const checkUser = async () => {
            try {
                ...
                if (error) {
                    console.error("Erro ao obter sessão na Home:", error);
                    setChecking(false);
                    return;
                }
                ...
                console.error("Erro inesperado na Home:", e);
            ...
            <section className="relative pt-20 pb-20 md:pt-32 md:pb-32 overflow-hidden">
              ...
              ao próximo nível.
                    ...
                    <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
                        A ferramenta definitiva para treinadores de Padel. Cria, organiza e
                        partilha exercícios táticos em segundos. Deixa o papel e a caneta no
                        passado.
                    </p>
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb  -16">
                        ...
                        <p className="text-slate-400">
                            Desenvolvido por treinadores, para treinadores.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                        <div className="col-span-1 md:col-span-2 bg-slate-800 p-8 rounded-3xl border border-slate-700 relative overflow-hidden group hover:border-green-500/30 transition duration-300">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-bold mb-2 text-white">
                                    Editor de Planos Profissional
                                </h3>
                                <p className="text-slate-400 mb-6 max-w-md">
                                    Constrói aulas completas selecionando exercícios da tua
                                    biblioteca. Gera PDFs automáticos com a tua marca.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-800 p-8 rounded-3xl border border-slate-700 hover:border-blue-500/50 transition relative group">
                            ...
                            <p className="text-slate-400 text-sm">
                                Categoriza os teus treinos por &quot;Ataque&quot;,
                                &quot;Defesa&quot; e encontra tudo em segundos.
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-800 p-8 rounded-3xl border border-slate-700 hover:border-purple-500/50 transition relative group">
                            ...
                            <p className="text-slate-400 text-sm">
                                No tablet dentro do court ou no PC em casa. A tua biblioteca
                                viaja contigo.
                            </p>
                        </div>

                        <div className="col-span-1 md:col-span-2 bg-linear-to-br from-green-600 to-emerald-900 p-8 rounded-3xl relative overflow-hidden text-white flex flex-col justify-center shadow-xl">
                            <div className="z-10">
                                <Shield className="mb-4 text-green-200" size={40} />
                                <h3 className="text-2xl font-bold mb-2">Privacidade Garantida</h3>
                                <p className="text-green-100 mb-4 max-w-md">
                                    Os teus segredos estão seguros. Mantém as tuas táticas
                                    privadas.
                                </p>
                            </div>
