...
export default function PlansPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (plansError) {
                    console.error('Erro a carregar planos:', plansError);
                }
                ...
                console.error('Erro inesperado em PlansPage:', e);
            } finally {
    ...
    const downloadPlanPDF = async (plan: any) => {
        ...
        try {
            ...
            if (plan.plan_items && plan.plan_items.length > 0) {
                ...
                doc.setFontSize(10);
                doc.text('Sem exercícios neste plano.', 20, yPos);
            }
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-slate-900 flex items-center justify-center text-green-500 animate-pulse">
                A carregar...
            </div>
        );
    }
