...
export default function UpdatePassword() {
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        try {
            // Esta função serve tanto para quem recuperou conta como para quem quer mudar a pass estando logado
            ...
            router.push('/dashboard'); // Manda para o dashboard
        ...
        <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
            <div className="bg-slate-800 p-8 rounded-2xl shadow-2xl w-full max-w-md border border-slate-700">
                <div className="text-center mb-6">
                    ...
                    <p className="text-slate-400 text-sm">Escolhe uma nova password segura.</p>
                </div>
                ...
                <form onSubmit={handleUpdate} className="space-y-4">
                    <div className="relative">
                        ...
                        <input
                            type="password" placeholder="Nova Password (mín. 6 caracteres)" required minLength={6}
